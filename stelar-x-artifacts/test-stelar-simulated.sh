...
# Choose the run directory beneath the resolved shared data root.
...
echo "  simphy data dir: $SIMPHY_DATA_DIR"
...
📁 Stats saved to: $STAT_FILE" ntfy.sh/anik-phylo-stx || true
fi
