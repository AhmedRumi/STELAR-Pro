...
public class TreeNode implements TreePrinter.PrintableNode {
    ...
    // Position of this exact leaf occurrence in its gene tree traversal.
    // In STELAR-Pro the same species label may appear multiple times in one
    // gene tree. Storing the occurrence position prevents range construction
    // from confusing one copy of a species with another copy of the same species.
