...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Enable cross-tree recombination to test the extension algorithm
        // This generates mixed bipartitions but still uses only gene tree bipartitions for DP
        boolean enableCrossTreeRecombination = true;
        List<RangeBipartition> candidates = geneTrees.generateExtendedCandidateBipartitions(enableCrossTreeRecombination);
        System.out.println("Total candidate bipartitions (for DP): " + candidates.size());
